...
#### Controllers
 - [SubmissionController.java](https://github.com/tecnico-softeng/es20al_18-project/blob/ppa/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/submission/SubmissionController.java)

### Feature testing

Each subgroup member defined one reading test and one writing test. The direct links to these are:

 - [CreateSubmissionTest](https://github.com/tecnico-softeng/es20al_18-project/blob/ppa/backend/jmeter/submission/WSCreateSubmissionTest.jmx)
 - [CreateReviewSubmissionTest](https://github.com/tecnico-softeng/es20al_18-project/blob/ppa/backend/jmeter/submission/WSCreateReviewSubmissionTest.jmx)
 - [GetSubmissionStatusTest](https://github.com/tecnico-softeng/es20al_18-project/blob/ppa/backend/jmeter/submission/WSGetSubmissionStatusTest.jmx)
...
##### Create Review
![Response body](assets/img/P2/Ppa/JMeterCreateReview1.png)
![Summary report](assets/img/P2/Ppa/JMeterCreateReview2.png)
![DB Cleanup](assets/img/P2/Ppa/JMeterCreateReview3.png)
...
Each subgroup member defined one reading test and one writing test. The direct links to these are:
 ...
 - [CreateSubmissionLoadTest](https://github.com/tecnico-softeng/es20al_18-project/blob/ppa/backend/jmeter/submission/WSCreateSubmissionLoadTest.jmx)
 - [CreateReviewSubmissionLoadTest](https://github.com/tecnico-softeng/es20al_18-project/blob/ppa/backend/jmeter/submission/WSCreateReviewSubmissionLoadTest.jmx)
 - [GetSubmissionStatusLoadTest](https://github.com/tecnico-softeng/es20al_18-project/blob/ppa/backend/jmeter/submission/WSGetSubmissionStatusLoadTest.jmx)
...
##### Create Review
![Summary report](assets/img/P2/Ppa/JMeterCreateReviewLoad1.png)
![DB Cleanup](assets/img/P2/Ppa/JMeterCreateReviewLoad2.png)
...
##### Create Review
![Profiling percentages](assets/img/P2/Ppa/CreateReview1.png)
![Profiling graphs](assets/img/P2/Ppa/CreateReview2.png)
![Profiling heap](assets/img/P2/Ppa/CreateReview3.png)
