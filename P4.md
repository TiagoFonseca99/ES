...
### Subgroup
 ...
 - Daniel Serafim, ist189428, dserafim1999
   + Issues assigned: [#176](https://github.com/tecnico-softeng/es20al_18-project/issues/176),
                      ...
                      [#276](https://github.com/tecnico-softeng/es20al_18-project/issues/276)
...
#### Feature number 5: _Um docente pode alterar uma pergunta aprovada antes de a colocar como fazendo parte do conjunto de perguntas disponíveis_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/cde989bcfba7ee5f2c959cdc704d30e88d75c276/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/submission/SubmissionService.java#L165)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/cde989bcfba7ee5f2c959cdc704d30e88d75c276/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/submission/service/ChangeSubmissionTest.groovy)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/cde989bcfba7ee5f2c959cdc704d30e88d75c276/backend/jmeter/submission/WSChangeSubmissionTest.jmx)
   + Screenshots:

     ![Test results](assets/img/P4/Ppa/jmeter_ppa5.png)

 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_18-project/blob/cde989bcfba7ee5f2c959cdc704d30e88d75c276/frontend/tests/e2e/specs/teacher/changeSubmission.js)
   + Screenshot:
...
#### Feature number 8: _O aluno decide se esta informação no seu dashboard deve ser pública ou privada_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/cde989bcfba7ee5f2c959cdc704d30e88d75c276/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/user/UserService.java#L125)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/cde989bcfba7ee5f2c959cdc704d30e88d75c276/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/user/service/DashboardInfoVisibilityTest.groovy)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/cde989bcfba7ee5f2c959cdc704d30e88d75c276/backend/jmeter/user/WSChangeSubmissionStatsVisibility.jmx)
 ...
 - [ ] Cypress use case test
    + Since the test would only be clicking on a button without any visible consequence, we chose to not implement it
