...
Esta funcionalidade foi implementada no sprint anterior, tendo só implementado os testes neste sprint.

 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/submission/SubmissionService.java#L186)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/submission/service/CreateReviewTest.groovy) (adaptámos um teste já existente para contemplar esta nova mudança)
 - [X] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/jmeter/submission/WSCreateReviewSubmissionTest.jmx) (adaptámos um teste já existente para contemplar esta nova mudança)
   + Screenshots:

     ![Test results](assets/img/P4/Ppa/Ppa_4_jmeter.png)

 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/frontend/tests/e2e/specs/teacher/approvedSubmissionMakesQuestionAvailable.js)
   + Screenshot:
...
#### Feature number 5: _Um docente pode alterar uma pergunta aprovada antes de a colocar como fazendo parte do conjunto de perguntas disponíveis_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/submission/SubmissionService.java#L165)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/submission/service/ChangeSubmissionTest.groovy)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/jmeter/submission/WSChangeSubmissionTest.jmx)
   + Screenshots:

     ![Test results](assets/img/P4/Ppa/jmeter_ppa5.png)

 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/frontend/tests/e2e/specs/teacher/changeSubmission.js)
   + Screenshot:

     ![Test results](assets/img/P4/Ppa/cypress_ppa5.png)

#### Feature number 6: _Uma pergunta rejeitada pode ser alterada e resubmetida pelo aluno_

 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/submission/SubmissionService.java#L76)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/submission/service/ResubmitQuestionTest.groovy) 
 - [X] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/jmeter/submission/WSResubmitQuestionTest.jmx) 
   + Screenshots:

     ![Test results](assets/img/P4/Ppa/Ppa_6_jmeter.png)

 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/frontend/tests/e2e/specs/student/resubmitQuestions.js)
   + Screenshot:
...
#### Feature number 7: _Dashboard do aluno_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/user/UserService.java#L116)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/user/service/GetDashboardInfoTest.groovy)
 - [X] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/jmeter/user/WSGetDashboardInfo.jmx) 
   + Screenshots:

     ![Test results](assets/img/P4/Ppa/Ppa_7_jmeter.png)

 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/frontend/tests/e2e/specs/student/checkDashboardInfo.js)
   + Screenshot:
...
#### Feature number 8: _O aluno decide se esta informação no seu dashboard deve ser pública ou privada_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/user/UserService.java#L125)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/user/service/DashboardInfoVisibilityTest.groovy)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/jmeter/user/WSChangeSubmissionStatsVisibility.jmx)

   + Screenshots:

     ![Test results](assets/img/P4/Ppa/jmeter_ppa8.png)
...
#### _Course Execution Dashboard_
 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/course/CourseService.java) 
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/course/service/GetCourseDashboardInfoTest.groovy) 
 - [X] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/451f7734fdc4f05e3707316100b971ac49f1546e/backend/jmeter/user/WSGetDashboardInfo.jmx) 
   + Screenshots:
...
### Subgroup
 ...
 - Nome, ist189429, DMaxter
   ...
   + Tasks: Ddp\_4: Functionality and Spock Tetsts, Ddp\_4: Web Services, Ddp\_4: Frontend
            Ddp\_6: Functionality and Spock Tetsts, Ddp\_6: Web Services, Ddp\_6: Frontend
            Ddp\_7.1: Functionality and Spock Tetsts, Ddp\_7.1: Web Services, Ddp\_7.1: Frontend
            Ddp\_8: Functionality and Spock Tetsts, Ddp\_8: Web Services, Ddp\_8: Frontend

 - Nome, ist189477, jpaquete14
   + Issues assigned:
   ...
   + Tasks: Ddp\_5: Functionality and Spock Tetsts, Ddp\_5: Web Services, Ddp\_5: Frontend
            Ddp\_7.2: Functionality and Spock Tetsts, Ddp\_7.2: Web Services, Ddp\_7.2: Frontend
...
#### Feature number 4: _O aluno pode criar respostas_

 - [x] [Service](https://github.com/tecnico-softeng/es20al_18-project/blob/p4/)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_18-project/blob/p4/)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_18-project/blob/p4/)
   + Screenshots:
