...
export default class ReviewsView extends Vue {
    ...
    headers: object = [
        ...
        { text: 'Creation Date', value: 'questionDto.creationDate', align: 'center' },
    ...
    async created() {
        ...
        try {
            [this.submissions] = await Promise.all([RemoteServices.getSubsToTeacher()]);
            [this.reviews] = await Promise.all([RemoteServices.getReviewsToTeacher()]);
