describe('Student walkthrough', () => {
  ...
  it('login submits a question with argument', () => {
    cy.submitQuestionArgument('Test Question','How many years will this pandemic last?','1','2','3','300', 'Argument');
